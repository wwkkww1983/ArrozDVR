...
Public Declare Function capCreateCaptureWindow Lib "avicap32.dll" Alias "capCreateCaptureWindowW" (ByVal lpszWindowName As String, ByVal dwStyle As Long, ByVal x As Long, ByVal y As Long, ByVal nWidth As Long, ByVal nHeight As Integer, ByVal hWndParent As Long, ByVal nID As Long) As Long
...
Sub LogError(ErrNum As Long, ErrorMsg As String, Optional ProcName As String = "")
  On Error GoTo ErrHandler
  Dim nUnit As Integer
  nUnit = FreeFile
  
  MsgBox "Error " & ErrNum & ", " & ErrorMsg
  
  Open JoinPathFile(App.Path, App.EXEName) & ".log" For Append As nUnit
  Print #nUnit, Format$(Now, "yyyy-mm-dd hh:mm:ss") & " "; ErrNum & ", " & ErrorMsg
  Close nUnit
  Exit Sub

ErrHandler:
  'MsgBox "Error in " & ProcName & vbNewLine & ErrNum & ", " & ErrorMsg
End Sub

Public Function MyErrorCallback(ByVal lwnd As Long, ByVal iID As Long, ByVal ipstrStatusText As Long) As Long
    ...
    'LogError iID, usStatusText
    LogError iID, sStatusText
End Function
